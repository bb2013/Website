		...
		<div class="<?php echo $this->the_plugin->alias; ?>">
			...
			<div class="<?php echo $this->the_plugin->alias; ?>-content">
				...
				<section class="<?php echo $this->the_plugin->alias; ?>-main">
					...
					<div class="psp-gAnalytics-box-statistics panel panel-default <?php echo $this->the_plugin->alias; ?>-panel col-xs-12 col-md-12 col-lg-3 col-lg-offset-1 smaller-width">
